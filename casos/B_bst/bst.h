...
bool TreeNode<T>::find(T val) {
    //Si val es igual al valor del nodo regresar verdadero
    if (val == value){
        return true;
    }
...
void BST<T>::add(T val) {
    ...
    //Sino, agregar un nuevo nodo sobre la raíz
    }else{
        root->add(val);
    }
}
